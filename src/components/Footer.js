    ...
    <footer className="bg-surface-dim w-full py-8 border-t border-border-glass">
      <div className="flex flex-col md:flex-row justify-between items-center px-12 max-w-7xl mx-auto">
        <div className="flex flex-col items-center md:items-start gap-2">
          ...
          <nav aria-label="Footer Navigation" className="flex flex-col md:flex-row gap-12 mt-6 md:mt-0">
            <div className="flex flex-col gap-3">
              <span className="text-on-surface font-semibold text-sm">Product</span>
              <Link className="text-on-surface-variant hover:text-primary transition-colors text-xs" href="/pricing">Pricing</Link>
              <Link className="text-on-surface-variant hover:text-primary transition-colors text-xs" href="/login">Start Free Trial</Link>
            </div>
            <div className="flex flex-col gap-3">
              <span className="text-on-surface font-semibold text-sm">Resources</span>
              <Link className="text-on-surface-variant hover:text-primary transition-colors text-xs" href="/blog">Blog</Link>
              <Link className="text-on-surface-variant hover:text-primary transition-colors text-xs" href="/contact">Contact Support</Link>
            </div>
            <div className="flex flex-col gap-3">
